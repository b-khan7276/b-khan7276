                ...
                <div class="row fill-width">
                    <section class="column">
                        ...
                        <svg class="bar" xmlns="http://www.w3.org/2000/svg" width="220" height="8">
                            ...
                            <rect mask="url(#issues-bar)" x="0" y="0" width="52.20338983050848" height="8" fill="#238636"/>
                            <rect mask="url(#issues-bar)" x="52.20338983050848" y="0" width="0" height="8" fill="#56d364"/>
                            <rect mask="url(#issues-bar)" x="52.20338983050848" y="0" width="0" height="8" fill="#8B949E"/>
                            <rect mask="url(#issues-bar)" x="52.20338983050848" y="0" width="0" height="8" fill="#c9d1d9"/>
                            <rect mask="url(#issues-bar)" x="52.20338983050848" y="0" width="167.79661016949152" height="8" fill="#8957e5"/>
                        ...
                        <div class="followup legend field fill-width">
                            ...
                            <div class="field">
                                ...
                                <span class="no-wrap">90 <small>closed</small></span>
                            </div>
                            <div class="field">
                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 16" width="16" height="16">
                    ...
                    <section class="column">
                        ...
                        <svg class="bar" xmlns="http://www.w3.org/2000/svg" width="220" height="8">
                            ...
                            <rect mask="url(#issues-bar)" x="0" y="0" width="2.4719101123595504" height="8" fill="#238636"/>
                            <rect mask="url(#issues-bar)" x="2.4719101123595504" y="0" width="0" height="8" fill="#56d364"/>
                            <rect mask="url(#issues-bar)" x="2.4719101123595504" y="0" width="2.4719101123595504" height="8" fill="#8B949E"/>
                            <rect mask="url(#issues-bar)" x="4.943820224719101" y="0" width="0" height="8" fill="#c9d1d9"/>
                            <rect mask="url(#issues-bar)" x="4.943820224719101" y="0" width="6.591760299625468" height="8" fill="#da3633"/>
                            <rect mask="url(#issues-bar)" x="11.535580524344569" y="0" width="0" height="8" fill="#ff7b72"/>
                            <rect mask="url(#issues-bar)" x="11.535580524344569" y="0" width="208.46441947565543" height="8" fill="#8957e5"/>
                            <rect mask="url(#issues-bar)" x="220" y="0" width="0" height="8" fill="#d2a8ff"/>
                        </svg>
                        <div class="followup legend field fill-width">
                            <div class="field">
                            ...
                            <div class="field">
                                ...
                                <span class="no-wrap">253 <small>merged</small></span>
                            </div>
                            <div class="field">
                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 16" width="16" height="16">
                                ...
                                <span class="no-wrap">3 <small>drafts</small></span>
                            </div>
                            <div class="field">
                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 16" width="16" height="16">
                                ...
                                <span class="no-wrap">8 <small>closed</small></span>
                            </div>
                        </div>
                    </section>
                </div>
